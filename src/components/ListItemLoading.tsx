export default function ListItemLoading({ border }: { border: string }) {
  return (
    <div
      className={`border-b-1 p-4 ${border} relative flex flex-row items-center gap-4 overflow-hidden`}
    >
      <div className="animate-sheen absolute inset-0 bg-gradient-to-r from-transparent via-gray-600 to-transparent" />
      <div
        className={`flex h-8 w-8 items-center justify-center overflow-hidden rounded-full bg-gray-700`}
      ></div>
